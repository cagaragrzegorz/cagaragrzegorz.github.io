            ...
            <Row>
                <Col md={6} sm={12}>
                    ...
                    <p>
                        ...
                        <br />
                        - FE tester building solutions in GEB (Groovy), Cypress(TS) and currrently
                        Playwirght(TS).
                        <br />
                    ...
                    <p>
                        I am big fan of building test tools and utilities that help teams to work smoother and
                        bring transparency to the project - regarging test and quality status. That includes:
                        websites, data generators, test env version managers, test and env status reporters,
                        tools integrations to name few.
                    </p>
